...
var nextSlide = function() {
  if (window.currentSlide + 1 <= document.querySelectorAll('.slide').length) {
    ...
    document.title = document.getElementById(window.currentSlide).querySelector('h1') ? document.getElementById(window.currentSlide).querySelector('h1').innerHTML : 'bmtjs';
    return true;
  }
  return false;
};
